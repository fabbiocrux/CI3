...
**But**: 
Réaliser le modèle ***CAO Pièce*** à partir du dessin technique **fait de un de vos collèges**. 
...
**But**: 
Réaliser le modèle ***CAO Pièce*** et le dessin technique à partir d'un pièce imprimé. 
...
[🎥 Tutorial sur l'interface](https://learn.onshape.com/learn/course/navigating-onshape/onshape-interface/trash)
:::
:::


## Interface <br> à la interface {background-image="TP1/onshape/01-environnement.jpeg" background-size="60%" background-position="100% 20%"}
