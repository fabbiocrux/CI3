...
### Comment réaliser un dessin de définition?

[Capsule sur le dessin technique par l'Université Numerique](https://moodle.luniversitenumerique.fr/mod/h5pactivity/view.php?id=10183)
...
## Exercise 2 {background-image="TP1/Ex2.svg" background-size="35%" background-position="98% 50%"}
