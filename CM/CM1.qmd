...
- **Concevoir un produit/service est une activité complexe**, cela implique de: 
  - Mobiliser de multiples partenaires de différentes disciplines, 
  - Imaginer des solutions créatives et pratiques, 
  - Tester et vériﬁer mille problèmes avant soit trop tard.
...
# Challenge d'initiation {.center background-color="aquamarine"}

**Formez des équipes de quatre/cinq personnes**

-   De préférence, avec vos voisins entre les rangs.

### Challenge Tour autoportante { background-color="aquamarine" background-image="CM1/eiffel-tower.png" background-size="15%" background-position="85% 5%"}
