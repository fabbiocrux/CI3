---
title: "CM2: Introduction à la conception des systèmes mécatroniques"
subtitle: "Conception et Innovation -CI3-"
image: CM2/systeme.png
metadata-files:
  - _metadata.yml  
format:
  revealjs:
...
# Challengue Conception et Innovation 3
...
- **Analyser** → Analyser les fonctions et la structure des systèmes complexes pluritechnologiques rencontrés.
- **Modéliser** → Proposer une représentation équationnelle d’un système en vue d’une simulation.
- **Résoudre** → Réaliser une simulation manuelle (calculs) ou assistée par logiciel pour pouvoir prévoir le comportement d’un système.
- **Experimenter** → Réaliser des mesures sur un système réel pour valider le comportement anticipé par simulation.
- **Concevoir** → Proposer une évolution matérielle ou logicielle pour améliorer le comportement d’un système et la réaliser.
- **Communiquer** → Traiter des informations et mettre en œuvre une communication.
:::
...
## Referentiel Compétence ENSGSI {.scrollable .smaller}
...
### Vocabulaire {.scrollable .smaller}
...
![](CM2/Escoba.png){width="80%" fig-align="center"}
...
![Cycle en V d'un projet](CM2/Cycle-projet-00.png){width="40%" fig-align="center"}

### Cycle en V ... plus detaillé

![Cycle en V d'un projet](CM2/Cycle-projet-01.png){width="80%" fig-align="center"}

### Cycle en V ... (encore) plus detaillé

![Cycle en V d'un projet](CM2/Cycle-projet-012.png){width="80%" fig-align="center"}

### oui, mais comment on peut faire cela au ENSGSI? {.center .plain}

![Cycle en V d'un projet](CM2/Cycle-projet-01-proto.png){width="80%" fig-align="center"}

### Avec une approche iteratif ...

::: {layout="[[45, -5, 55]]"}
![Cycle en V d'un projet](CM2/Cycle-projet-01-proto.png){width="100%" fig-align="center"}

![Cycle iteratif](CM2/Cycle-projet-02.png){width="100%" fig-align="center"}
:::
...
![](CM2/Wooclap.png){width="70%" fig-align="center"}
...
::::: columns
::: {.column width="50%"}
![](CM2/Cycle-projet-01.png){width="80%" fig-align="center"}
:::
...
![](CM2/Chaine-energie.png){width="70%" fig-align="center"}
...
![](CM2/Chaine-energie-example.png){width="80%" fig-align="center"}

## La Chaîne d'Information

### Chaîne d'Information

![](CM2/Chaine-info.png){width="70%" fig-align="center"}
...
![Chaîne d'Information et d'Energie](CM2/Chaine-energie-Info-00.png){width="7cm" fig-align="center"}

### Structure globale d’un système $\rightarrow$ Mécanique

![Point vue Mécanique](CM2/Chaine-energie-Info-00-Mecanique.png){width="10cm" fig-align="center"}

### Structure globale d’un système $\rightarrow$ Electrique

![Point vue Mécanique](CM2/Chaine-energie-Info-00-Electrique.png){width="10cm" fig-align="center"}

### Structure globale d’un système $\rightarrow$ Informatique

![Point vue Informatique](CM2/Chaine-energie-Info-00-Informatique.png){width="10cm" fig-align="center"}
...
::::: columns
::: {.column width="45%"}
![Composants de la chhaîne d'Energie](CM2/Next-1.png)
:::

::: {.column width="45%"}
![Composants de la chaîne d'Information](CM2/Next-2.png)
:::
:::::