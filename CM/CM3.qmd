...
# Où en sommes-nous ? {.unnumbered background-image="CM3/onshape-00.png" background-size="700px" background-position="100% 50%"}

:::{layout="[40,50]" layout-valign="center"}

- **`Modelisation Pièce CAO`** : <br>Modélisation de la pièce à partir d’un dessin technique

:::

## Objectif pédagogique de cet après-midi {#objectif-pédagogique-de-cet-après-midi .unnumbered}

1.  🧠 **Connaissances**:  Identifier les differents *liasons mécaniques.*
2.  🔨 **Savoir-faire**:   Faire un *schéma cinématique* d'un mécanisme.
3.  ✍ **Compétences**: Être capable de *modéliser le mouvement* d'un mécanisme et réaliser une simulation cinématique.

::: {.callout-tip title="🚨 Objectif du jour"}
**Faire les graphs de liaisons et schémas cinématiques des certaines mécanismes !!!**
:::
...
## Degree de liberté {background-image="CM3/Degrees-liberte.png" background-size="20%" background-position="85% 85%" .smaller}
...
1.  **TRANSLATION (RECTILIGNE)** : les trajectoires de tous les points du solide sont des droites parallèles. $T_x, T_y, T_z$ selon $(x,y,z)$

2.  **ROTATION** : les trajectoires de chaque point sont des cercles coaxiaux. $R_x, R_y, R_z$ autour des axes $(x,y,z)$
...
1. **Regroupement des pièces en ensembles solides**
2. [Élaboration du graphe des liaisons]{fg=grey}
3. [Construction du schéma cinématique]{fg=grey}


::: {layout="[70,30]" layout-valign="center"}
::: {.class}
<br><br>
🔎 On regroupe les pièces dans des ensembles (appelés **Classes d’équivalence cinématique**)<br>
✍️ Un nom (Une lettre par exemple) <br>
🔵 Une couleur
:::

:::

### Classes d’équivalence cinématique -- CEC {background-image="CM3/Schema-Cine-01.png" background-size="25%" background-position="95% 30%"} 


::: {.callout-attention title="Définition"}
*Une Classe d'équivalence cinématique est l'ensemble des pièces qui ont le même mouvement pendant le fonctionnement du mécanisme*.
:::

✍️ Une lettre = {`#Pièces du même C.E.C `} <br>
🔵 Une couleur<br>

::: {layout="[20,30]" layout-valign="center"}
::: {}
- [O = {0}]{bg=blue fg=black}
- [I = {1}]{bg=red fg=white}
- [II = {2}]{bg=grey fg=white}
- [III = {3}]{bg=green fg=white}

:::

![](CM3/Graphe-des-liaisons.png){width="300px" fig-align="left"}
...
### Etapes  {background-image="CM3/Schema-Cine-02.png" background-size="30%" background-position="100% 30%" .smaller} 

1. [Regroupement des pièces en ensembles solides]{.grey}
2. **Élaboration du graphe des liaisons**
3. [Construction du schéma cinématique]{.grey}

::: {layout="[30,40]" layout-valign="center"}

:::.{}
<br>
Analyser pour ***chaque liaison***

$L_{0-I}$ : Pivot d’axe $(𝐴,\vec{z})$<br>
$L_{I-II}$ : Pivot d’axe $(𝐵,\vec{z})$<br>
$L_{II-III}$ : Pivot glissant d’axe $(𝐶,\vec{z})$<br>
$L_{III-0}$ : Pivot glissant d’axe $(𝐴,\vec{y})$<br>

:::
![](CM3/Graphe-des-liaisons-01.png){width="300px" fig-align="left"}
...
Source: [http://benchtophybrid.com/mechdes/ch01/driverDyad.html?sel=0](http://benchtophybrid.com/mechdes/ch01/driverDyad.html?sel=0)
